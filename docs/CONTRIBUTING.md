...
* 文言変更や見た目の大幅な変更といった、コンテンツの意味を変えるものについては、関係者の確認が必要です。ご了承下さい。
...
* `#proj-stopcovid19hokkaido` チャンネルにご参加ください。
...
* [good first issue ラベルのついたもの](https://github.com/codeforjapan/remote-patient-monitoring/issues?q=is%3Aopen+is%3Aissue+label%3Agood-first-issue)は初心者におすすめです
